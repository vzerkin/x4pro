...
#---U-235
 ${mypython3} -B reac2pfns.py -o:pfns235u_t -x:x2 -Ei:0.0253 -T:1.31e6 -x1min:0.0253 -x1max:0.0363 -fx:1e6 \
   ...
   >pfns235u_t.tto
 ${mypython3} -B reac2pfns.py -o:pfns235u0_5 -rsp1:F51-18-3.txt -x:x2 -x1min:5e5 -x1max:5.3e5 -fx:1e6 -xmin:0.01 -xmax:30 -ymin:0.3 -ymax:1.6 -xlog -lines -sym \
...
#---U-238
 ...
 ${mypython3} -B reac2pfns.py -o:pfns238u14_3 -x:x2 -x1:14.3e6 -bw -fx:1e6 -xmin:0.1 -xmax:40 -ymin:0.3 -ymax:3.5 -xlog -lines -sym "92-U-238(N,F),PR,NU/DE" -annot:"1,3.2,<sup>238</sup>U(n<sub>14.3MeV</sub>,f) PFNS">pfns238u14_3.tto
...
#${mypython3} -B reac2pfns.py -o:pfns232th2_6 -x:x2 -x1:2.6e6 -fx:1e6 -xlog -lines -sym "90-TH-232(N,F),PR,NU/DE,,REL" -annot:"1e-7,3.2,<sup>232</sup>Th(n<sub>2.6MeV</sub>,f) PFNS">pfns232th2_6.tto
 ${mypython3} -B reac2pfns.py -o:pfns232th2_6 -x:x2 -x1min:2.8e6 -x1max:2.9e6 -fx:1e6 -xlog -xmin:2e-5 -xmax:30 -ymin:0.45 -ymax:1.45 -lines -sym "90-TH-232(N,F),PR,NU/DE,,NPD" "90-TH-232(N,F),PR,NU/DE,,REL" -annot:"0.005,1.35,<sup>232</sup>Th(n<sub>2.9MeV</sub>,f) PFNS">pfns232th2_6.tto

#---Np-237
 ${mypython3} -B reac2pfns.py -o:pfns237np0_5 -x:x2 -bw -x1:5.2e5 -fx:1e6 -xmin:0.001 -xmax:30 -xlog -lines -sym "93-NP-237(N,F),PR,NU/DE" -annot:"0.02,1.5,<sup>237</sup>Np(n<sub>0.5MeV</sub>,f) PFNS">pfns237np0_5.tto
...
python -B reac2pfns.py -o:pfns232th2_6 -x:x2 -x1:7.3e6 -fx:1e6 -xlog -lines -sym "90-TH-232(N,F),PR,NU/DE,,NPD" -annot:"1e-7,3.2,<sup>232</sup>Th(n<sub>2.6MeV</sub>,f) PFNS">pfns232th2_6.tto
python -B reac2pfns.py -o:pfns232th2_6 -x:x2 -x1:14.7e6 -fx:1e6 -xlog -lines -sym "90-TH-232(N,F),PR,NU/DE,,NPD" -annot:"1e-7,3.2,<sup>232</sup>Th(n<sub>2.6MeV</sub>,f) PFNS">pfns232th2_6.tto
python -B reac2pfns.py -o:pfns232th2_6 -x:x2 -x1:2.9e6 -fx:1e6 -xlog -lines -sym "90-TH-232(N,F),PR,NU/DE,,NPD" -annot:"1e-7,3.2,<sup>232</sup>Th(n<sub>2.6MeV</sub>,f) PFNS">pfns232th2_6.tto
python -B reac2pfns.py -o:pfns232th2_6 -x:x2 -x1min:2.8e6 -x1max:2.9e6 -fx:1e6 -xlog -xmin:2e-5 -xmax:30 -ymin:0.45 -ymax:1.45 -lines -sym "90-TH-232(N,F),PR,NU/DE,,NPD" "90-TH-232(N,F),PR,NU/DE,,REL" -annot:"0.005,1.35,<sup>232</sup>Th(n<sub>2.9MeV</sub>,f) PFNS">pfns232th2_6.tto

python -B reac2pfns.py -o:pfns235u7_4 -x:x2 -x1min:7e6 -x1max:8e6 -fx:1e6 -xmin:0.01 -xmax:40 -ymin:0.5 -ymax:1.95 -xlog -lines -sym "92-U-235(N,F),PR,NU/DE" -annot:"0.2,1.8,<sup>235</sup>U(n<sub>7.4MeV</sub>,f) PFNS">pfns235u7_4.tto
python -B reac2pfns.py -o:pfns235u7_4 -rsp1:F51-1814.txt -x:x2 -x1min:7e6 -x1max:8e6 -fx:1e6 -xmin:0.01 -xmax:40 -ymin:0.5 -ymax:1.95 -xlog -lines -sym "92-U-235(N,F),PR,NU/DE" -annot:"0.2,1.8,<sup>235</sup>U(n<sub>7.4MeV</sub>,f) PFNS">pfns235u7_4.tto
