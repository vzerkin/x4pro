...
SELECT x4.DatasetID,ds.year1 as YearRef1                              \n\
 ...
 WHERE (ds.Targ1 like '"+target+"')                                   \n\
  ...
  and (x4.DatasetID='142710031' or x4.DatasetID='41455005'            \n\
--    or x4.DatasetID='13801002'                                        \n\
--    or x4.DatasetID='40563002'                                        \n\
--    or x4.DatasetID='107340021'                                       \n\
    or x4.DatasetID='40824002'                                        \n\
--    or x4.DatasetID='40563002'                                        \n\
--    or x4.DatasetID='40020002'                                        \n\
  )                                                                   \n\
...
def getDatasets4plot(rows,fx=1e-6,fy=1):
    lx=len(rows)
    datasets=[]
