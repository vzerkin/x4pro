...
<head>
<meta charset="UTF-8">
<title>X4Pro-View</title>
<script src="../x4js/plotly-2.min.js"></script>
<link rel="stylesheet" type="text/css" href="../x4js/x4pro2.css">
<script src="../x4js/zvSwitch.js"></script>
<script src="../x4js/gg.js"></script>
<script src="../x4js/eep.js"></script>
<script src="../x4js/eepd.js"></script>
